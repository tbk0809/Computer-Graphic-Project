        ...
        if (imAttacking) {
            ...
            if (imAttackTimer > 200) {
                ...
                for (int i = 0; i < 16; i++) {
                    ...
                    glVertex3f(coreX + px*1.5f, coreY + py*1.5f, coreZ - dist);
                    glColor4f(1.0f, 1.0f, 1.0f, 0.9f);
                    glVertex3f(coreX + px,      coreY + py,      coreZ - dist*0.5f);
                }
                ...
                glPushMatrix();
                    ...
                    glRotatef(imAttackTimer * 25.0f, 0, 1, 0);
                    glRotatef(imAttackTimer * 15.0f, 1, 0, 0);
                ...
                glPushMatrix();
                    ...
                    glutSolidSphere(beamRadius * 2.0f, 16, 16);
                glPopMatrix();
        ...
        if (caAttackingShield) {
            ...
            glPushMatrix();
                ...
                if (caAttackTimer <= 180 && caAttackTimer > 40)
                    glRotatef(caAttackTimer * 65.0f, 0.0f, 1.0f, 0.0f);
                else
